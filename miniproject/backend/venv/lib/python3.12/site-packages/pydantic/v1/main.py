...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def from_orm(cls: Type['Model'], obj: Any) -> 'Model':
        if not cls.__config__.from_attributes:
            raise ConfigError('You must have the config attribute from_attributes=True to use from_orm')
    ...
    def validate(cls: Type['Model'], value: Any) -> 'Model':
        ...
        if isinstance(value, dict):
            return cls(**value)
        elif cls.__config__.from_attributes:
